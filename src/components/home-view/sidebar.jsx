            ...
            { isUsersLoading ? 
                ...
                users?.map((user) => (
                    <button 
                        ...
                        className={`w-full p-3 flex items-center gap-3 transition-colors ${selectedUser?._id === user._id ? "bg-base-300 ring-1 ring-base-300 hover:bg-black" : "hover:bg-[#eaf3ffff]"}`}
                    >
